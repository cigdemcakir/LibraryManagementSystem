...
try
{
            ...
            o.Events = new JwtBearerEvents
            {
                OnMessageReceived = context =>
                {
                    ...
                    if (!string.IsNullOrEmpty(accessToken) &&
                        path.StartsWithSegments("/Hubs/BookHub") )
                    {
    ...
    builder.Services.AddScoped<IBookHubService, BookHubManager>();
...
{
    Log.Fatal(ex, "LibraryManagement.Application terminated unexpectedly");
}
finally
{
    Log.CloseAndFlush();
